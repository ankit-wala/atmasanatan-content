...
|  33 | holika-dahan                | [ ]      | |
|  34 | indira-ekadashi             | [x]      | Yudhishthira's opening question expanded (pitru loka connection); Narada's speech expanded: explains WHY this Ekadashi helps pitars (Pitru Paksha timing + Indira = Lakshmi's grace crosses loka boundaries); vidhi-listing sentence replaced with dialogue scene — Indrasena asks about the name, Narada explains Lakshmi etymology + prophecy that the first devotee will live on in the name |
...
|  87 | shani-jayanti               | [ ]      | |
|  88 | shani-pradosh               | [x]      | FULL REWRITE (subtitle + Katha + Significance): subtitle "क्षमा माँगी" (Shani asked forgiveness — story never delivered this) → "जब शनि ने तप से शिव को प्रसन्न कर न्याय का पद पाया"; dropped unsourced Kailash Ananda-Tandava assembly scene (belongs to main pradosh-vrat chapter — now points to it like som/bhaum siblings); new authentic day-deity katha matching series pattern — Shani (son of Surya+Chhaya), fearsome drishti, does tapasya to Shiva → Shiva grants the office of karmaphala-daata + grace clause that Shiva-worship (esp. Shani-Pradosh) tempers his justice; merchant couple + Satyaratha kept as Skanda Purana illustration anecdotes; Significance: Shiva-derived authority + Pippalada folk-tradition thread (peepal + spares under-16); meta.yaml sources expanded. ROUND 2 (annotations): narrative opening replacing dry cross-reference (evokes manthan→Neelkanth→Pradosh); प्रदोष defined inline (सूर्यास्त की सँझ); Shiva's boon expanded — grace for those who do प्रायश्चित + दूसरों का भला (reform lightens old karma); Satyaratha elaborated to full Skanda Purana Pradosha-Mahatmya arc (Shalva siege, queen killed by graha, orphan prince, Uma the widow, Ekacakra, Shandilya reveals prev-birth Pandya king's interrupted Pradosh worship, prince regains kingdom); Significance trimmed (cut Katha-repetition) + added when-it-occurs mechanism (Trayodashi falling on Saturday, 2–3×/year) |
